...
### Acesso por IP em desenvolvimento

Se o campo `isDevelop` estiver como `true`, o site poderá ser acessado diretamente pelo IP na porta 80 usando o caminho `/<nome-do-site>`. Exemplo: `http://<IP_DA_MAQUINA>/example`. Essa rota ignora o domínio configurado e serve o site correspondente ao `name`.
